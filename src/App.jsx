...
function App() {
  ...
  const astralThrob = () => {
    ...
    setStationName("Nhac Em Thich");
    setYoutubeChannal("https://www.youtube.com/channel/UC_2xOulfOUHbBR-sty6psZQ");
    setLivestream(
      "https://www.youtube.com/watch?v=UedTcufyrHc&ab_channel=Nightrhttps://www.youtube.com/watch?v=NT-foME4e5MideFM"
    );
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
